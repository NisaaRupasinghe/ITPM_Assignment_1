...
```
git clone <https://github.com/NisaaRupasinghe/ITPM_Assignment_1/tree/main>
```
...
```
python test_automation.py --excel "IT23388970_Assignment_1_Test_Cases.xlsx" --sheet "Assignment 1 Test Cases" --url "https://www.pixelssuite.com/chat-translator" --wait-ms 20000 --type-delay-ms 80 --slow-mo-ms 200 --save-every 1
```
